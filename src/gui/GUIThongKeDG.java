 ...
 */
public class GUIThongKeDG extends javax.swing.JFrame {

    /**
     * Creates new form GUIThongKeDG
     */
    int xx;
    int xy;
    int clickedButton = 0;
    ...
    private void btn_gtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_gtMouseClicked
        try {
            ...
            resetLblColor(btn_ns);
            DocGiaDAO.TK(tableTK, "GIOI_TINH", "Giới tính");
            clickedButton = 1;
...
//        resetLblColor(btn_gt);
        ...
        try {
            ...
            resetLblColor(btn_dt);
            resetLblColor(btn_gt);
            DocGiaDAO.TK(tableTK, "DIA_CHI", "Nơi sống");
            clickedButton = 2;
        } catch (ClassNotFoundException | SQLException ex) {
            Logger.getLogger(GUIThongKeDG.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        if (clickedButton == 1)
            DocGiaDAO.TK_The_loai(tableTK, "Giới tính", "THỐNG KÊ SỐ LƯỢNG ĐỘC GIẢ THEO GIỚI TÍNH");
        if (clickedButton == 2)
            DocGiaDAO.TK_The_loai(tableTK, "Nơi sống", "THỐNG KÊ SỐ LƯỢNG ĐỘC GIẢ THEO NƠI SỐNG");
        if (clickedButton == 3)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIThongKeDG.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIThongKeDG().setVisible(true);
            }
        });
    }
